            ...
            <div className="relative w-full lg:h-[210px] md:h-[200px] sm:h-[170px] h-[130px]">
                ...
                <div className="relative bottom-[74px]">
                    <div className="2xl:px-[60px] sm:px-[0] px-[16px] container mx-auto flex flex-col ">
                        <a href="/" className="text-[30px] text-[var(--pri)] font-[700]">Chó cảnh </a>
                        <div className="flex gap-[5px]">
                            <a href="/" className="text-[17px] text-[var(--pri)] flex gap-[1px] items-center"><span>Trang chủ</span> <MdKeyboardDoubleArrowRight /></a>
                            <a href="/" className="text-[17px] text-[var(--pri)] flex gap-[1px] items-center"><span>Chó cảnh</span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className=" container mx-auto">
                    <div className="flex gap-[60px]">
                        ...
                        <div className="flex-1 flex flex-col">
                            <div className="lg:text-[36px] xd:text-[30px] text-[26px] text-[var(--pri)] font-[700]">Chó cảnh</div>
                            ...
                            <div className="mb-[10px] py-[20px] grid xl:grid-cols-3 md:grid-cols-2 grid-cols-2 place-items-center gap-x-[20px] md:gap-y-[20px] gap-y-[15px]">
                                <CategoryPet/>
                                <CategoryPet/>
                                <CategoryPet/>
                                <CategoryPet/>
