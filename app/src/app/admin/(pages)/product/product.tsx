        ...
        <> 
            <div className="xl:w-[calc(100%-240px)] lg:w-[calc(100%-220px)] w-full absolute top-[100px] xl:left-[240px] lg:left-[220px] left-0 flex flex-col xl:px-[40px] mx-[16px] xl:pr-[55px] pr-[26px]">
                ...
                <div className="flex gap-[20px] items-center mt-[20px] flex-wrap">
                    ...
                    <a href="/admin/product/create" className="text-[white] text-[14px] hover:bg-[var(--second)] bg-[var(--pri)] py-[20px] px-[25px] rounded-[10px] border border-gray-300">+ Tạo mới</a>
                </div>
                            ...
                            <table className="xl:w-full w-[1200px]">
                                <thead className="bg-[#e5e1e1] ">
                                    <tr className="">
                                        ...
                                        <td className="p-[15px] md:text-[14px] text-[12px] font-[600] py-[10px] w-[180px]">Tên sản phẩm </td>
                                        <td className="p-[15px] md:text-[14px] text-[12px] font-[600] py-[10px] w-[250px]">Ảnh đại diện</td>
                                        <td className="p-[15px] md:text-[14px] text-[12px] font-[600] py-[10px] w-[130px]">Số lượng</td>
                                ...
                                <tbody className="">
                                    <tr>
                                        ...
                                        <td className="p-[15px]">
                                            <div className="flex">
                                                <a href="/admin/product/edit" className="rounded-l-[10px] text-[14px] p-[15px] bg-[white] border-y border-l border-gray-300">
