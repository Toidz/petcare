    ...
    return(
         <>
            <div className="xl:w-[calc(100%-240px)] lg:w-[calc(100%-220px)] w-full absolute top-[100px] xl:left-[240px] lg:left-[220px] left-0 flex flex-col mx-[16px] px-[30px] pr-[55px]">
                <div className="text-[30px] font-[700] mb-[30px]">Tạo danh mục</div>
                <div className="mb-[30px] grid grid-cols-2 gap-y-[20px] gap-x-[30px] bg-[white] py-[30px] px-[40px] border border-gray-300 rounded-[15px]">
                    ...
                    <div className="flex flex-col col-span-2">
                        ...
                        <div className="mt-[30px] flex flex-col items-center gap-y-[20px]">
                            <button className="w-[270px] hover:bg-[var(--second)] rounded-[10px] text-[20px] text-white bg-[var(--pri)] px-[20px] py-[20px]">Tạo mới danh mục</button>
