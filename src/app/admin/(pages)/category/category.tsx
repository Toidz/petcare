    ...
    return(
        <> 
            <div className="xl:w-[calc(100%-240px)] lg:w-[calc(100%-220px)] w-full absolute top-[100px] xl:left-[240px] lg:left-[220px] left-0 flex flex-col xl:px-[40px] mx-[16px] xl:pr-[55px] pr-[26px]">
                <div className="text-[30px] font-[700] mb-[30px]">Quản lý danh mục</div>
                ...
                <div className="flex gap-[20px] items-center mt-[20px] flex-wrap">
                    ...
                    <a href="/admin/category/create" className="text-[white] text-[14px] hover:bg-[var(--second)] bg-[var(--pri)] py-[20px] px-[25px] rounded-[10px] border border-gray-300">+ Tạo mới</a>
                </div>
                <div className="mt-[20px]">
                    <div className="flex flex-col px-[30px] bg-[white] py-[30px] rounded-[20px]" >
                        <div className="overflow-x-auto">
                            <table className="xl:w-full  w-[1000px]">
                                ...
                                <tbody className="">
                                    <tr>
                                        ...
                                        <td className="p-[15px]">
                                            <div className="flex">
                                                <a href="/admin/category/edit" className="rounded-l-[10px] text-[14px] p-[15px] bg-[white] border-y border-l border-gray-300">
